    ...
    productos.forEach(producto => {
        ...
        div.innerHTML = `<div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary" id=boton${producto.id}>Comprar ${producto.nombre}</button>
                            </div>
                        </div>`
...
// mostrarProductos(productos)
// const mostrarProductos = (acolchados) => {
//     const contenedorProductos = document.getElementById('producto-contenedor')
//     acolchados.forEach(acolchado => {
//         const div = document.createElement('div');
//         div.classList.add('card');
//         div.innerHTML = `<div class="card" style="width: 18rem;">
//                             <img src="${acolchado.img}" class="card-img-top" alt="...">
//                             <div class="card-body">
//                                 <h5 class="card-title">${acolchado.nombre}</h5>
//                                 <p class="card-text">Descripción:  ${acolchado.desc}</p>
//                                 <p class="card-text">Precio:$ ${acolchado.precio}</p>
//                                 <button class="btn btn-primary" id=boton${acolchado.id}>Comprar</button>
//                             </div>
//                         </div>`
//         contenedorProductos.appendChild(div)

//         const boton = document.getElementById(`boton${acolchado.id}`);
//         boton.addEventListener('click', ()=>{
//             carritoIndex(acolchado.id)
//             alert(`Se agrego ${acolchado.nombre} al carrito`)
//         } )
